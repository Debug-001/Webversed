      ...
      <section className="pricing-section">
          <div className="text-group p-5">
            ...
            <p className="pt-3 pb-1">
              ...
              you get precisely what you need while maintaining control over
              your budget. Whether you're a small startup or a large enterprise,
              our pricing is designed to accommodate every business, so you can
                      ...
                      <div className="card-body1">
                        ...
                        <Fade direction="up">
                          <ul className="pricing-nav">
                            <li>
                              <IoCheckmark className="check-icon" /> Landing
                              Pages
                            </li>
                            <li>
                    ...
                    >
                      <div className="card-body1">
                        ...
                        <Fade direction="up">
                          <ul className="pricing-nav">
                            <li>
                              <IoCheckmark className="check-icon" /> User
                              Research & Strategy
                            </li>
                            <li>
                              <IoCheckmark className="check-icon" /> App
                              designing
                            </li>
                            <li>
                      ...
                      <div className="card-body1">
                        ...
                        <Fade direction="up">
                          <ul className="pricing-nav">
                            ...
                            <li>
                              <IoCheckmark className="check-icon" /> Technical
                              SEO
                            </li>
                            <li>
                        ...
                        <form>
                          ...
                          <div className="mb-3">
                            <label htmlFor="message" className="col-form-label">
                              Drop any Additional Message such as your budget
                              etc.
                            </label>
                            <input
                              type="text"
              ...
              <div className="qa-text">
                <Fade direction="up">
                  ...
                  <p className="pt-2 px-4">
                    ...
                    looking for? Our support team is just a message away, ready
                    to assist you.
                  </p>
                </Fade>
              </div>
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      The Price of your Project depends on both the Complexity
                      and the Type of Webpage you need. Let me know about the
                      Details of your Project and I'll be able to create an
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      website design and content to improve your site's
                      visibility on search engines. Additionally, we offer
                      ongoing SEO services to help you rank higher and attract
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      you need payment gateways, CRM integration, or social
                      media plugins, we've got the expertise to integrate them
                      seamlessly.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      complexity and features. Generally, a simple website can
                      be completed within a few weeks, while more complex
                      projects may take several months. We'll provide you with a
                      detailed timeline after discussing your project
                      requirements.
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col mx-5 pt-5 pb-4">
                    ...
                    <Fade direction="up">
                      <p className="">
                        ...
                        boundaries of financial success. Contact us now and get
                        it done right now.
                      </p>
                    </Fade>
                  </div>
