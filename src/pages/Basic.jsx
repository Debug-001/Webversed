      ...
      <div className="container py-5">
        <div className="row mb-5">
          <div className="col-md-8 col-xl-6 text-center mx-auto">
            <h2 className="fw-bold">Choose from these amazing preset</h2>
            <p className="text-muted">
              Bring your portfolio to life and be Internship/Job ready!!
            </p>
          </div>
        </div>
        <div
            ...
            <div>
              <a href="#">
                <img
                  ...
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20161751.jpg"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                ...
                <a className="btn btn-primary" role="button" href="/pricing ">
                  Select and Pay!
                </a>
              </div>
            </div>
          ...
          <div className="col mb-4">
            <div>
              <a href="#">
                <img
                  className="rounded img-fluid shadow w-100 fit-cover"
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20161911.jpg"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                <a
                  ...
                  role="button"
                  href="https://portoflio001.bss.design/"
                  style={{ fontSize: 13 }}
                >
                  Website
                </a>
          ...
          <div className="col mb-4">
            <div>
              <a href="#">
                <img
                  className="rounded img-fluid shadow w-100 fit-cover"
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20162001.png"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                <a
                  ...
                  role="button"
                  style={{ width: "126.637px", fontSize: 13 }}
                  href="https://premium-portfolio-6.netlify.app/"
                >
                  Website
                </a>
                <h4 className="fw-bold" />
          ...
          <div className="col mb-4">
            <div>
              <a href="#">
                <img
                  className="rounded img-fluid shadow w-100 fit-cover"
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20162244.jpg"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                <a
                  ...
                  role="button"
                  style={{ width: "126.637px", fontSize: 13 }}
                  href="https://premium-portfolio-4.netlify.app/"
                >
                  Website
                </a>
                <h4 className="fw-bold" />
          ...
          <div className="col mb-4">
            <div>
              <a href="#">
                <img
                  className="rounded img-fluid shadow w-100 fit-cover"
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20162457-3.jpg"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                <a
                  ...
                  role="button"
                  style={{ width: "126.637px", fontSize: 13 }}
                  href="https://premium-portfolio-2.netlify.app/"
                >
                  Website
                </a>
                <h4 className="fw-bold" />
          ...
          <div className="col mb-4">
            <div>
              <a href="#">
                <img
                  className="rounded img-fluid shadow w-100 fit-cover"
                  src="src/pages/assets/img/products/Screenshot%202023-01-30%20162803.jpg"
                  style={{ height: 250 }}
                />
              </a>
              <div className="py-4">
                <a
                  ...
                  role="button"
                  style={{ width: "126.637px", fontSize: 13 }}
                  href="https://premium-portfolio-1.netlify.app/"
                >
                  Website
                </a>
                <h4 className="fw-bold" />
