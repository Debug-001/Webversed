    ...
    <div className="container py-5">
      <div className="row mb-5">
        <div className="col-md-8 col-xl-6 text-center mx-auto">
          <h2 className="fw-bold">Choose from these Premium presets</h2>
        ...
        <div className="col mb-4">
          <div>
            <a href="#">
              <img
                className="rounded img-fluid shadow w-100 fit-cover"
                src="img/products/94a51f_a5a62567ca6b403ba0361deada2f7a76_mv2.png"
                style={{ height: 250 }}
              />
            </a>
            <div className="py-4">
              <a
                className="btn btn-light"
                role="button"
                href="https://www.sophiebritt.com/"
              >
                Website
              </a>
              <h4 className="fw-bold" />
        ...
        <div className="col mb-4">
          <div>
            <a href="#">
              <img
                className="rounded img-fluid shadow w-100 fit-cover"
                src="img/products/94a51f_f1ae57c171e5491b90cea6f1709727fa_mv2.png"
                style={{ height: 250 }}
              />
            </a>
            <div className="py-4">
              <a
                className="btn btn-light"
                role="button"
                href="https://static.wixstatic.com/media/94a51f_f1ae57c171e5491b90cea6f1709727fa~mv2.jpg/v1/fill/w_733,h_489,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/94a51f_f1ae57c171e5491b90cea6f1709727fa~mv2.jpg"
              >
                Website
              </a>
              <h4 className="fw-bold" />
        ...
        <div className="col mb-4">
          <div>
            <a href="#">
              <img
                className="rounded img-fluid shadow w-100 fit-cover"
                src="img/products/0e0314_cc6036ac70ca490c8c59b7baf57f06bd_mv2.png"
                style={{ height: 250 }}
              />
            </a>
            <div className="py-4">
        ...
        <div className="col mb-4">
          <div>
            <a href="#">
              <img
                className="rounded img-fluid shadow w-100 fit-cover"
                src="img/products/0e0314_cb34104a6104428e89d36f6834639914_mv2.png"
                style={{ height: 250 }}
              />
            </a>
            <div className="py-4">
              <a
                className="btn btn-light"
                role="button"
                href="https://www.thaiphamphotography.com/"
              >
                Website
              </a>
              <h4 className="fw-bold" />
